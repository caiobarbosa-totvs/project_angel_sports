...
/*	var codigosTasks = getTaskCodes;*/
	...
	if(MODE == "ADD" && atividadeAtual == getTaskCodes.ZERO || atividadeAtual == getTaskCodes.INICIO || atividadeAtual == getTaskCodes.AJUSTE){
...
/*	 *//**
	 ...
	 */
/*	if(atividadeAtual != codigosTasks.INICIO){
